...
#ifndef RTF_BLOCK_VECTOR_H_
#define RTF_BLOCK_VECTOR_H_
 ...
 */
template <typename T>
class Vector : public FunctionBlock {
 public:
  /**
   * @brief Initialize Vector function block.
   */
  explicit Vector(const BlockConfigurator& configurator);
...
template <typename T>
Vector<T>::Vector(const BlockConfigurator& configurator) : FunctionBlock(configurator) {
